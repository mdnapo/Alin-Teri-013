    ...
    <div class="uploadoverlaycontent">
        ...
        <table>
            <form method="POST" enctype="multipart/form-data">
                <tr>
                    <td><b>Foto*:</b></td>
                    <td><input type="file" id="fileSelect" name="image" value="Kies je foto" accept="image/*" required/>
                    </td>
                </tr>
                <tr>
        ...
        <p>Uw e-mailadres wordt niet openbaar gemaakt. Deze is alleen zodat wij eventueel met u in contact kunnen
            komen.</p>
    </div>
</div>
...
<div class="container">
    <div class="content">
        ...
        <div class="text">
            Wij van Alin Teri zien graag wie ons steunen. Daarom hebben wij een eigen actie: laat je steun zien met een
            foto! Hieronder kun je zien wie ons steunen. Wil jij ook je steun laten zien? Stuur ons jou foto in!
        </div>
        <div class="donaties">
