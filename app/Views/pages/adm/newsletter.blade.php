...
@section('adminPanel')
    ...
    <form method="POST" enctype="multipart/form-data" action="{{ url('/admin/newsletter') }}">
        ...
        <div class="control-group form-group">
            Upload een bestand en deze wordt automatisch verstuurd naar iedereen die zich heeft ingeschreven voor de
            nieuwsbrief!
                ...
                <div class="col-lg-6">
                    ...
                    <table id="table" class="table table-striped table-hover">
                        ...
                        @foreach($files as $file)
                            <tr>
                                <td><a target="_blank"
                                       href="{{ asset('newsletter/' . $file->getFilename()) }}">{{ $file->getFilename() }}</a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
